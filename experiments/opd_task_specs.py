...
TASK_SPECS = {
    ...
    "place_container_plate": TaskSpec(max_control_steps=400),
    "move_pillbottle_pad": TaskSpec(max_control_steps=400),
    "place_object_stand": TaskSpec(max_control_steps=400),
